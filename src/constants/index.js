...
export const CLEAR_WAITING_ERROR = 'CLEAR_WAITING_ERROR';

/* GAME ACTIONS */
export const RESET_GAME_STATE = 'RESET_GAME_STATE';
export const UPDATE_GAME_CREATOR = 'UPDATE_GAME_CREATOR';
...
export const UPDATE_TRACK_URL = 'UPDATE_TRACK_URL';
